...
- **Fork** - a change to code. Minor change = soft fork. Fundamental changes = hard fork, the latter leading to the formation of a separate chain with different rules.
